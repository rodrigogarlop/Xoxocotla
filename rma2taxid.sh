#!/bin/bash
# Update 2021-02-04: By Rodrigo García-López I removed the working directory to receive only full paths for the rma6 files instead. This script will now output a taxid-count table
...
if [ $# -eq 3 ]; then
	...
	echo "salida txt $FLN"
	rma2info -i $FL1 -o $FLN -c2c Taxonomy -v # -vo true
	echo "Hecho"
	conda deactivate
else
