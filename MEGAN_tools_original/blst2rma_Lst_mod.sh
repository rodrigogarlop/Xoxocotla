...
##
## ej. ejecución: qsub -R y -l h_rt=23:59:59 -t 1-4 /scratch/victorsg/Programs/blst2rma_Lst.sh /scratch/victorsg/Data/MarieClaire/ReadRECUP TodosBlast.txt TodosReads.txt /scratch/victorsg/dbs/megan/megan-nucl-Jan201.db 110000M
##
#$ -N blst2rma_Lst_p
#$ -cwd
#$ -pe mpi 2
...
#$ -j y
#$ -o /scratch/rodrigog/01_Projects/Xoxo/01_data/MEGAN
## Activamos conda
...
sed -i 's/-Xmx8000M/-Xmx$MEM/g' /home/rodrigog/.conda/envs/megan/opt/megan-6.21.2/MEGAN.vmoptions
...
sed -i 's/-Xmx$MEMM/-Xmx8000/g' /home/rodrigog/.conda/envs/megan/opt/megan-6.21.2/MEGAN.vmoptions
